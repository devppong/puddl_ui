...
function Dashboard(props: any) {
	...
	const [selectedComponent, setSelectedComponent] = useState(() => {
		// const isPageReloaded = performance.type === 'reload';
		const storedValue = sessionStorage.getItem("selected-nav-item");
			...
			<Box sx={{ display: "flex" }}>
				...
				<AppBar position="absolute" open={open}>
					...
					>
						...
						<TextField id="outlined-basic" label="sk-Ti7..." variant="outlined" sx={{bgcolor:'whitesmoke', width:'20vw',margin:'0 5vw'}} />
